    ...
    static PyObject* Task_Run(py::wrapper::Microsoft::Windows::ApplicationModel::Background::UniversalBGTask::Task* self, PyObject* args) noexcept
    {
        ...
        if (arg_count == 1)
        {
            try
            {
                ...
                {
                    is_overload_present = winrt::Windows::Foundation::Metadata::ApiInformation::IsMethodPresent(L"Microsoft.Windows.ApplicationModel.Background.UniversalBGTask.Task", L"Run", 1);
                }
