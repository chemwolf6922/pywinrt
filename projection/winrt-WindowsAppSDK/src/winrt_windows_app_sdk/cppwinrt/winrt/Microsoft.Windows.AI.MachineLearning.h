...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Microsoft_Windows_AI_MachineLearning_IExecutionProviderCatalog<D>::EnsureAndRegisterAllAsync() const
    {
        void* operation{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->EnsureAndRegisterAllAsync(&operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>**)this;
    ...
    template <typename D> auto consume_Microsoft_Windows_AI_MachineLearning_IExecutionProviderCatalog<D>::RegisterAllAsync() const
    {
        void* operation{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->RegisterAllAsync(&operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>**)this;
    ...
    struct produce<D, winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog> : produce_base<D, winrt::Microsoft::Windows::AI::MachineLearning::IExecutionProviderCatalog>
    {
        ...
        int32_t __stdcall EnsureAndRegisterAllAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Windows::AI::MachineLearning::ExecutionProvider>, double>>(this->shim().EnsureAndRegisterAllAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall RegisterAllAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Windows::Foundation::Collections::IVector<winrt::Microsoft::Windows::AI::MachineLearning::ExecutionProvider>, double>>(this->shim().RegisterAllAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
